...
accepted_languages_qwen3_asr = _CONFIG["accepted_languages_qwen3_asr"]
granite_source_target_languages = _CONFIG["granite_source_target_languages"]
granite_target_languages = _CONFIG["granite_target_languages"]
granite_allowed_language_pairs = _CONFIG["granite_allowed_language_pairs"]
